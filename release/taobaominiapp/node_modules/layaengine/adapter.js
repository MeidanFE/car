...
Object.defineProperty(exports, "__esModule", { value: true });
var HTMLAudioElement_1 = __webpack_require__(/*! ./HTMLAudioElement */ "./src/HTMLAudioElement.ts");
...
var Audio = /** @class */ (function (_super) {
    ...
    function Audio(url) {
        ...
        _this.readyState = 0 /* HAVE_NOTHING */;
        _this.$sn = SN_SEED++;
        _this.$currentTime = 0;
        ...
        innerAudioContext.onCanplay(function () {
            _this.$loaded = true;
            _this.readyState = 2 /* HAVE_CURRENT_DATA */;
        ...
        innerAudioContext.onTimeUpdate(function () {
            _this.dispatchEvent({ type: 'timeupdate' });
        });
        innerAudioContext.onEnded(function () {
            ...
            _this.readyState = 4 /* HAVE_ENOUGH_DATA */;
        });
...
Object.defineProperty(exports, "__esModule", { value: true });
var HTMLElement_1 = __webpack_require__(/*! ./HTMLElement */ "./src/HTMLElement.ts");
var Body = /** @class */ (function (_super) {
    __extends(Body, _super);
    function Body() {
        return _super.call(this, "body" /* body */, 0) || this;
    }
    return Body;
...
var Canvas = /** @class */ (function (_super) {
    ...
    function Canvas() {
        var _this = _super.call(this, "canvas" /* canvas */) || this;
        _this.id = defaultCanvasID;
        return _this;
        // console.log('[Canvas.ts] create canvas...');
    }
    ...
    Canvas.prototype.getContext = function (contextType) {
        ...
        if (contextType === '2d') {
            ...
            ctx = this.$realCanvas.getContext('webgl');
            ctx.canvas = this.$realCanvas;
            this.$glContext = ctx;
        }
        return ctx;
    };
...
var DocumentElement = /** @class */ (function (_super) {
    ...
    function DocumentElement() {
        return _super.call(this, "html" /* html */, 0) || this;
    }
...
var WindowProperties_1 = __webpack_require__(/*! ./WindowProperties */ "./src/WindowProperties.ts");
...
var $window = __webpack_require__(/*! ../window */ "./src/window.ts");
    ...
    return function (rawEvent) {
        ...
        if (!my.isIDE) {
            for (var index = 0; index < event.changedTouches.length; index++) {
                ...
                element.pageX = element.x || element.pageX;
                element.pageY = element.y || element.pageY;
            }
            for (var index = 0; index < event.touches.length; index++) {
                var element = event.touches[index];
                element.pageX = element.x || element.pageX;
                element.pageY = element.y || element.pageY;
            }
        }
...
Object.defineProperty(exports, "__esModule", { value: true });
var TouchEvent_1 = __webpack_require__(/*! ./TouchEvent */ "./src/EventIniter/TouchEvent.ts");
Object.defineProperty(exports, "TouchEvent", { enumerable: true, get: function () { return TouchEvent_1.TouchEvent; } });
Object.defineProperty(exports, "onReceivedTouchEvent", { enumerable: true, get: function () { return TouchEvent_1.onReceivedTouchEvent; } });
...
Object.defineProperty(exports, "__esModule", { value: true });
var HTMLMediaElement_1 = __webpack_require__(/*! ./HTMLMediaElement */ "./src/HTMLMediaElement.ts");
var HTMLAudioElement = /** @class */ (function (_super) {
    __extends(HTMLAudioElement, _super);
    function HTMLAudioElement() {
        return _super.call(this, "audio" /* audio */) || this;
    }
...
var util_1 = __webpack_require__(/*! ./util */ "./src/util/index.ts");
var WindowProperties_1 = __webpack_require__(/*! ./WindowProperties */ "./src/WindowProperties.ts");
var decorators_1 = __webpack_require__(/*! ./decorators */ "./src/decorators/index.ts");
var HTMLElement = /** @class */ (function (_super) {
    ...
    Object.defineProperty(HTMLElement.prototype, "style", {
        get: function () {
            var innerWidth = WindowProperties_1.default.innerWidth, innerHeight = WindowProperties_1.default.innerHeight;
            this.$style = __assign({
                top: '0px',
                left: '0px',
                width: innerWidth + "px",
    ...
    ], HTMLElement.prototype, "parentNode", null);
    __decorate([
        decorators_1.enumerable(true)
...
var HTMLVideoElement = /** @class */ (function (_super) {
    ...
    function HTMLVideoElement() {
        return _super.call(this, "video" /* video */) || this;
    }
...
Object.defineProperty(exports, "__esModule", { value: true });
var EventTarget_1 = __webpack_require__(/*! ./EventTarget */ "./src/EventTarget.ts");
var util_1 = __webpack_require__(/*! ./util */ "./src/util/index.ts");
...
Object.defineProperty(exports, "__esModule", { value: true });
var HTMLVideoElement_1 = __webpack_require__(/*! ./HTMLVideoElement */ "./src/HTMLVideoElement.ts");
...
Object.defineProperty(exports, "__esModule", { value: true });
var performance_1 = __webpack_require__(/*! ./performance */ "./src/performance.ts");
var screenInfo = {};
var WindowProperties = /** @class */ (function () {
    ...
    WindowProperties.prototype.screenInfoAsync = function () {
        return new Promise(function (resolve, reject) {
            if (!screenInfo.windowWidth || !screenInfo.windowHeight) {
                my.getSystemInfo({
                    success: function (_a) {
                        var pixelRatio = _a.pixelRatio, screenHeight = _a.screenHeight, screenWidth = _a.screenWidth, windowHeight = _a.windowHeight, windowWidth = _a.windowWidth, statusBarHeight = _a.statusBarHeight, titleBarHeight = _a.titleBarHeight;
                        if (my.isIDE) {
                            pixelRatio = devicePixelRatio;
                            windowHeight -= (titleBarHeight + statusBarHeight);
                        }
                        screenInfo = {
    ...
    Object.defineProperty(WindowProperties.prototype, "screenInfo", {
        get: function () {
            if (!screenInfo.windowWidth || !screenInfo.windowHeight) {
                var _a = my.getSystemInfoSync(), windowWidth = _a.windowWidth, windowHeight = _a.windowHeight, screenWidth = _a.screenWidth, screenHeight = _a.screenHeight, pixelRatio = _a.pixelRatio, statusBarHeight = _a.statusBarHeight, titleBarHeight = _a.titleBarHeight;
                if (my.isIDE) {
                    pixelRatio = devicePixelRatio;
                    windowHeight -= (titleBarHeight + statusBarHeight);
                }
    ...
    Object.defineProperty(WindowProperties.prototype, "screen", {
        get: function () {
            var _a = this.screenInfo, windowWidth = _a.windowWidth, windowHeight = _a.windowHeight, screenWidth = _a.screenWidth, screenHeight = _a.screenHeight;
            return {
...
var Worker = /** @class */ (function () {
    function Worker(file) {
        var _this = this;
        this.onmessage = null;
        // 创建新Worker前, 需要结束现有的 Worker.terminate
...
var XMLHttpRequest = /** @class */ (function (_super) {
    ...
    XMLHttpRequest.prototype.getAllResponseHeaders = function () {
        ...
        return Object.keys(responseHeader)
            .map(function (header) { return header + ": " + responseHeader[header]; })
            .join('\n');
    };
    ...
    XMLHttpRequest.prototype.send = function (data) {
        ...
        if (this.readyState !== XMLHttpRequest.OPENED) {
            ...
            var success = function (_a) {
                var result = _a.data, statusCode = _a.status, headers = _a.headers;
...
var Event_1 = __webpack_require__(/*! ./Event */ "./src/Event.ts");
var HTMLElement_1 = __webpack_require__(/*! ./HTMLElement */ "./src/HTMLElement.ts");
var Video_1 = __webpack_require__(/*! ./Video */ "./src/Video.ts");
...
var DocumentElement_1 = __webpack_require__(/*! ./DocumentElement */ "./src/DocumentElement.ts");
var Body_1 = __webpack_require__(/*! ./Body */ "./src/Body.ts");
var events = {};
var document = {
    readyState: 'complete',
    ...
    createElement: function (tagName, opts) {
        ...
        if (tagName === "canvas" /* canvas */) {
            var _a = opts || {}, id = _a.id, _b = _a.width, width = _b === void 0 ? 100 : _b, _c = _a.height, height = _c === void 0 ? 100 : _c;
            if (id) {
        ...
        else if (tagName === "audio" /* audio */) {
            return new Audio_1.default();
        }
        else if (tagName === "image" /* img */) {
            return new Image_1.default();
        }
        else if (tagName === "video" /* video */) {
    ...
    querySelector: function (query) {
        ...
        else if (query === "body" /* body */) {
            return document.body;
        }
        else if (query === "canvas" /* canvas */) {
            return canvas;
        }
    ...
    head: new HTMLElement_1.default("head" /* head */),
...
function onVisibilityChange(visible) {
    return function () {
        ...
        document.visibilityState = visible ? "visible" /* VISIBLE */ : "hidden" /* HIDDEN */;
...
var WindowProperties_1 = __webpack_require__(/*! ./WindowProperties */ "./src/WindowProperties.ts");
var global = $global;
var window = Object.assign(WindowProperties_1.default, $window);
// @ts-ignore
...
function inject() {
    ...
    var canvas = window.document.createElement("canvas", { id: "canvas" });
    canvas.addEventListener = window.addEventListener;
...
performance.now = function () { return Date.now() - startTime; };
function performanceAsync() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, getServerTimeAsync()];
                case 1:
                    ...
                    return [2 /*return*/, {
                            ...
                            now: function () { return __awaiter(_this, void 0, void 0, function () {
                                var now;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, getServerTimeAsync()];
...
var Canvas_1 = __webpack_require__(/*! ./Canvas */ "./src/Canvas.ts");
Object.defineProperty(exports, "getCanvasByID", { enumerable: true, get: function () { return Canvas_1.getCanvasByID; } });
Object.defineProperty(exports, "getRealCanvasByID", { enumerable: true, get: function () { return Canvas_1.getRealCanvasByID; } });
var document_1 = __webpack_require__(/*! ./document */ "./src/document.ts");
Object.defineProperty(exports, "document", { enumerable: true, get: function () { return document_1.default; } });
var navigator_1 = __webpack_require__(/*! ./navigator */ "./src/navigator.ts");
Object.defineProperty(exports, "navigator", { enumerable: true, get: function () { return navigator_1.default; } });
var XMLHttpRequest_1 = __webpack_require__(/*! ./XMLHttpRequest */ "./src/XMLHttpRequest.ts");
Object.defineProperty(exports, "XMLHttpRequest", { enumerable: true, get: function () { return XMLHttpRequest_1.default; } });
var Worker_1 = __webpack_require__(/*! ./Worker */ "./src/Worker.ts");
Object.defineProperty(exports, "Worker", { enumerable: true, get: function () { return Worker_1.default; } });
var Image_1 = __webpack_require__(/*! ./Image */ "./src/Image.ts");
Object.defineProperty(exports, "Image", { enumerable: true, get: function () { return Image_1.default; } });
var Audio_1 = __webpack_require__(/*! ./Audio */ "./src/Audio.ts");
Object.defineProperty(exports, "Audio", { enumerable: true, get: function () { return Audio_1.default; } });
var FileReader_1 = __webpack_require__(/*! ./FileReader */ "./src/FileReader.ts");
...
var HTMLElement_1 = __webpack_require__(/*! ./HTMLElement */ "./src/HTMLElement.ts");
Object.defineProperty(exports, "HTMLElement", { enumerable: true, get: function () { return HTMLElement_1.default; } });
var index_1 = __webpack_require__(/*! ./EventIniter/index */ "./src/EventIniter/index.ts");
Object.defineProperty(exports, "TouchEvent", { enumerable: true, get: function () { return index_1.TouchEvent; } });
Object.defineProperty(exports, "onReceivedTouchEvent", { enumerable: true, get: function () { return index_1.onReceivedTouchEvent; } });
var localStorage_1 = __webpack_require__(/*! ./localStorage */ "./src/localStorage.ts");
...
exports.getMainCanvasIDFromCurrentPage = getMainCanvasIDFromCurrentPage;
// 此方法耗时：iOS 0.0*ms
...
var xRequestAnimationFrame_1 = __webpack_require__(/*! ./xRequestAnimationFrame */ "./src/xRequestAnimationFrame.ts");
Object.defineProperty(exports, "requestAnimationFrame", { enumerable: true, get: function () { return xRequestAnimationFrame_1.requestAnimationFrame; } });
Object.defineProperty(exports, "cancelAnimationFrame", { enumerable: true, get: function () { return xRequestAnimationFrame_1.cancelAnimationFrame; } });
Object.defineProperty(exports, "clearAllHandler", { enumerable: true, get: function () { return xRequestAnimationFrame_1.clearAllHandler; } });
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.clearAllHandler = exports.cancelAnimationFrame = exports.requestAnimationFrame = void 0;
var window_1 = __webpack_require__(/*! ./window */ "./src/window.ts");
var performance_1 = __webpack_require__(/*! ./performance */ "./src/performance.ts");
...
function handler() {
    ...
    if (canvas) {
        ...
        canvas.requestAnimationFrame(function () {
            ...
            // if (tempFlag % 60 === 0) {
            //   console.log(
            //     `==>[miniapp-game-adapter]<== <${getMainCanvasFromCurrentPage().id}>.requestAnimationFrame`,
            //     new Date().toLocaleTimeString()
            //   );
            // }
            requestAnimationFrame.run(startTime_1);
        });
    }
}
...
requestAnimationFrame.run = function (startTime) {
...
exports.clearAllHandler = clearAllHandler;
